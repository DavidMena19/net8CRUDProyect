...
namespace net8Proyect.Data.Migrations
{
    ...
    [Migration("20250304203513_eliminandoDatoInutilCarritoModel")]
    partial class eliminandoDatoInutilCarritoModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("net8Proyect.Models.Articulo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("net8Proyect.Models.Articulo", b =>
                {
                    b.HasOne("net8Proyect.Models.Categoria", "Categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("net8Proyect.Models.Carrito", b =>
                {
                    b.HasOne("net8Proyect.Models.Articulo", "Articulo")
                        .WithMany("Carrito")
            ...
            modelBuilder.Entity("net8Proyect.Models.CarritoDetalle", b =>
                {
                    ...
                    b.HasOne("net8Proyect.Models.Carrito", "Carrito")
                        .WithMany("Detalles")
                        .HasForeignKey("CarritoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("net8Proyect.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
